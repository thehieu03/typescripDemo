...
export const PhoneIcon: FC<IconProps> = ({
    ...
    return <svg className={className} fill="currentColor" color="inherit" fontSize="16" viewBox="0 0 48 48"
                xmlns="http://www.w3.org/2000/svg" width={width} height={height}>
        <path
            d="M20 9c0-1.1.9-2 2-2h4a2 2 0 1 1 0 4h-4a2 2 0 0 1-2-2ZM18 38.5c0-.83.67-1.5 1.5-1.5h9a1.5 1.5 0 0 1 0 3h-9a1.5 1.5 0 0 1-1.5-1.5Z"></path>
